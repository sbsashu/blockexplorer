...
export class RamPageComponent implements OnInit{
  ...
  buyChangeEOS(e) {
      this.scatterService.buyRAM.kb = this.scatterService.buyRAM.rix / this.scatterService.ramPrice;
  }
  buyChangeKB(e) {
      this.scatterService.buyRAM.rix = this.scatterService.ramPrice * this.scatterService.buyRAM.kb;
  }
  sellChangeEOS(e) {
      this.scatterService.sellRAM.kb = this.scatterService.sellRAM.rix / this.scatterService.ramPrice;
  }
  sellChangeKB(e) {
      this.scatterService.sellRAM.rix = this.scatterService.ramPrice * this.scatterService.sellRAM.kb;
  }  
